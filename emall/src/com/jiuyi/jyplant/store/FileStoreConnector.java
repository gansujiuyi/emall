...
public class FileStoreConnector implements StoreConnector {
    ...
    public StoreDTO save(String baseDir,String model, Resource resource, String originName)
            throws Exception {
    ...
    public StoreDTO get(String baseDir,String model, String key) throws Exception {
        if (key.indexOf("../") != -1) {
            StoreDTO storeDto = new StoreDTO();
            storeDto.setModel(model);
            storeDto.setKey(key);
    ...
    public void remove(String baseDir  ,String model, String key) throws Exception {
        if (key.indexOf("../") != -1) {
            return;
        }
